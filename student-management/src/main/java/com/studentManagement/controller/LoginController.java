...
public class LoginController {
	...
	public String login(@Valid @RequestParam("password") String pass, @RequestParam("id") int id,
			HttpServletRequest request, Model m) {

		Teacher teacherInfo = teachObj.getTeacherById(id);

		if (teacherInfo != null && pass.equals(teacherInfo.getPassword()) && id == (teacherInfo.getId())) {
