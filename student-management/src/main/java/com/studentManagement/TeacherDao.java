...
public class TeacherDao {
	...
	public void setJdbcTemplateTeacher(JdbcTemplate jdbcTemplateTeacher) {
		...
		public int save(Teacher t) {
			String sql = "insert into teacher(Id,Name,Email,MaritalStatus,Gender,Age,State,District,Password) values('" + t.getId() + "','"
					+ t.getName() + "','" +t.getEmail() + "','" +t.getMaritalStatus() + "','" +t.getGender() + "','" +t.getAge()
					+ "','" + t.getState() + "','"+t.getDistrict()+"','"+t.getPassword()+"')";
			return jdbcTemplateTeacher.update(sql);
		}
		
		public int update(Teacher t) {
			String sql = "update teacher set Name='"
					+ t.getName() + "',Email='" +t.getEmail() + "',MaritalStatus='" +t.getMaritalStatus() + "',Gender='" +t.getGender() + "',Age='" +t.getAge()
					+ "',State='" + t.getState() + "',District='"+t.getDistrict()+"',Password='"+t.getPassword()+"' where Id ="+t.getId()+"";
			return jdbcTemplateTeacher.update(sql);
		}
